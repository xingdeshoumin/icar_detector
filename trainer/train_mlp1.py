...
def parse_option():
    ...
    parser.add_argument('--epochs', type=int, help='the number of epoch', default=120)
    parser.add_argument('--batch_size', type=int, default=120, help='input batch size for training (default: 15)')
...
def main(args):
    ...
    while (1):
        ...
        if val_accurate > best_acc:
            ...
            filename = f"{args.save_path}model_{best_acc:.3f}percent_mlp.pth"
            torch.save(net.state_dict(), filename)
            filename = f"{args.save_path}model_{best_acc:.3f}percent_mlp.onnx"
